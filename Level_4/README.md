...
- brute-forcing strings of 1 to 4 characters (alphabet only), pre-pended with the "is" prefix
- brute-forcing strings of 1 to 4 characters (alphabet only), without the "is" prefix
